 ...
 */
public class Forscher extends AbstractUser {
	public Forscher(String username, String password, String fullName, String email, char sex, Date date) throws InvalidEmailInputException, InvalidNameInputException, InvalidSexInputException, InvalidPasswordInputException, InvalidUsernameInputException, InvalidDateInputException {
