...
<a href="UIController?gewuenschteSeite=rateBeitrag&action=like&id=<%=list.get(i).getID()%>">Like</a> | <a href="UIController?gewuenschteSeite=rateBeitrag&action=dislike&id=<%=list.get(i).getID()%>">Dislike</a> | <a href="#">Report</a>
</div>
<%} %>
